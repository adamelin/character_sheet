...
export class GenericButtonModel extends AbstractContainerModel {
  ...
  toString(): string {
    return 'GenericButtonModel/' + this.getName() + '/' + RmType[this.getRmType()];
  }
